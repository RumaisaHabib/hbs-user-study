 ...
 * MIT License
 */
(function(e,t,n){var r=[];var a=[];var i={_version:"3.6.0",_config:{classPrefix:"",enableClasses:true,enableJSClass:true,usePrefixes:true},_q:[],on:function(e,t){},addTest:function(e,t,n){a.push({name:e,fn:t,options:n})},addAsyncTest:function(e){a.push({name:null,fn:e})}};var o=function(){};o.prototype=i;o=new o;
/*!
{
...
!*/var b="CSS"in e&&"supports"in e.CSS;var x="supportsCSS"in e;o.addTest("supports",b||x);var w=i._config.usePrefixes?v.split(" "):[];i._cssomPrefixes=w;var Q=function(t){};i.atRule=Q;function T(e,t){return!!~(""+e).indexOf(t)}function C(){}function S(e,n,r,a){}var k=i.testStyles=S;
/*!
{
  "name": "Touch Events",
...
!*/o.addTest("touchevents",(function(){var n;if("ontouchstart"in e||e.DocumentTouch&&t instanceof DocumentTouch){n=true}else{var r=["@media (",s.join("touch-enabled),("),"heartz",")","{#modernizr{top:9px;position:absolute}}"].join("");k(r,(function(e){}))}return n}));
/*!
{
...
!*/o.addTest("formvalidation",(function(){var t=g("form");if(!("checkValidity"in t)||!("addEventListener"in t)){return false}if("reportValidity"in t){return true}var n=false;var r;o.formvalidationapi=true;t.addEventListener("submit",(function(t){}),false);t.innerHTML='<input name="modTest" required="required" /><button></button>';k("#modernizr form{position:absolute;top:-99999em}",(function(e){}));return n}));var R;(function(){var e={}.hasOwnProperty;if(!l(e,"undefined")&&!l(e.call,"undefined")){R=function(t,n){}}else{R=function(e,t){}}})();i._l={};i.on=function(e,t){};i._trigger=function(e,t){if(!this._l[e]){return}var n=this._l[e];setTimeout((function(){}),0);delete this._l[e]};function P(e,t){if(typeof e=="object"){for(var n in e){if(R(e,n)){P(n,e[n])}}}else{e=e.toLowerCase();var r=e.split(".");var a=o[r[0]];if(r.length==2){a=a[r[1]]}if(typeof a!="undefined"){return o}t=typeof t=="function"?t():t;if(r.length==1){o[r[0]]=t}else{if(o[r[0]]&&!(o[r[0]]instanceof Boolean)){o[r[0]]=new Boolean(o[r[0]])}o[r[0]][r[1]]=t}d([(!!t&&t!=false?"":"no-")+r.join("-")]);o._trigger(e,t)}return o}o._q.push((function(){i.addTest=P}));
/*!
{
...
!*/o.addAsyncTest((function(){var e=new Image;e.onerror=function(){};e.onload=function(){P("exiforientation",e.width!==2,{aliases:["exif-orientation"]})};e.src="data:image/jpeg;base64,"}));function D(e,t){}function L(e,t,n){var r;for(var a in e){if(e[a]in t){if(n===false){return e[a]}r=t[e[a]];if(l(r,"function")){return D(r,n||t)}return r}}return false}var _={elem:g("modernizr")};o._q.push((function(){delete _.elem}));var F={style:_.elem.style};o._q.unshift((function(){delete F.style}));function O(e){return e.replace(/([A-Z])/g,(function(e,t){return"-"+t.toLowerCase()})).replace(/^ms-/,"-ms-")}function j(t,n,r){}function N(t,r){var a=t.length;if("CSS"in e&&"supports"in e.CSS){while(a--){if(e.CSS.supports(O(t[a]),r)){return true}}return false}else if("CSSSupportsRule"in e){var i=[];while(a--){i.push("("+O(t[a])+":"+r+")")}i=i.join(" or ");return S("@supports ("+i+") { #modernizr { position: absolute; } }",(function(e){}))}return n}function I(e,t,r,a){a=l(a,"undefined")?false:a;if(!l(r,"undefined")){var i=N(e,r);if(!l(i,"undefined")){return i}}var o,s,f,u,c;var d=["modernizr","tspan","samp"];while(!F.style&&d.length){o=true;F.modElem=g(d.shift());F.style=F.modElem.style}function p(){if(o){delete F.style;delete F.modElem}}f=e.length;for(s=0;s<f;s++){u=e[s];c=F.style[u];if(T(u,"-")){u=A(u)}if(F.style[u]!==n){if(!a&&!l(r,"undefined")){try{F.style[u]=r}catch(e){}if(F.style[u]!=c){p();return t=="pfx"?u:true}}else{p();return t=="pfx"?u:true}}}p();return false}var U=i.testProp=function(e,t,r){};function z(e,t,n,r,a){var i=e.charAt(0).toUpperCase()+e.slice(1),o=(e+" "+w.join(i+" ")+i).split(" ");if(l(t,"string")||l(t,"undefined")){return I(o,t,r,a)}else{o=(e+" "+m.join(i+" ")+i).split(" ");return L(o,t,n)}}i.testAllProps=z;var M=i.prefixed=function(e,t,n){if(e.indexOf("@")===0){return Q(e)}if(e.indexOf("-")!=-1){e=A(e)}if(!t){return z(e,"pfx")}else{return z(e,t,n)}};
/*!
{
  "name": "Fullscreen API",
  "property": "fullscreen",
